...
namespace HoloToolkit.Unity.Preview.SpectatorView
{
    ...
    public class CameraCaptureHololens : MonoBehaviour
    {
        ...
        public void StartCapture()
        {
            ...
            if(!capturing)
            {
                Debug.Log("################### CameraCaptureHololens -> StartCapture!");
        ...
        {
            //Debug.Log("################### CameraCaptureHololens -> OnPhotoModeStarted() -> start function!");
            try
            {
                if (result.success)
                {
                    string filePath = Path.Combine(Application.persistentDataPath, string.Format("cognitive_analysis.jpg"));
                    photoCaptureObject.TakePhotoAsync(OnCapturedPhotoToMemory); // añade parametro result y otro mas
            ...
            //Debug.Log("################### CameraCaptureHololens -> OnPhotoModeStarted() -> end function!");
        }
